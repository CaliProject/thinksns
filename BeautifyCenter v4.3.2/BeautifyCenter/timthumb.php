...
if (!defined('MAX_WIDTH'))
    define('MAX_WIDTH', 3000); // Maximum image width
...
if (!defined('ERROR_IMAGE'))
    define('ERROR_IMAGE', 'image load failed, please contact mzw.me'); // Image to serve if an error occurs instead of showing error message 
    ...
    public function __construct()
    {
        ...
        if ($this->isURL) {
            if (ALLOW_ALL_EXTERNAL_SITES) {
                ...
                if (!$allowed) {
                    return $this->error("You may not fetch images from that site. To enable this site in timthumb, you can set ALLOW_EXTERNAL=true.");
                }
            }
        }
